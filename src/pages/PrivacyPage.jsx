      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              ...
              <p>
                ...
                We do not use analytics or tracking tools. Our hosting provider (AWS CloudFront)
                may log standard access data (IP address, request time, page visited) as part of
                normal infrastructure operations. Your theme preference is stored locally in your
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground mt-4">
              <li>Amazon Web Services (AWS) as our hosting and content delivery provider</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you've contacted us and want to know what data we have, need it corrected, or want it
              deleted — just email us at{' '}
              <a href="mailto:halderm@arkadia-labs.io" className="text-primary hover:underline">
                halderm@arkadia-labs.io
              </a>{' '}
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              This is a static website with no user accounts, databases, or server-side processing.
              All traffic is served over HTTPS via AWS CloudFront.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Our website is hosted on AWS infrastructure in the EU (Frankfurt). Content is delivered
              globally via AWS CloudFront edge locations, meaning access logs may be processed outside
              of Switzerland. AWS operates under standard contractual clauses for data protection.
            </p>
          </section>
